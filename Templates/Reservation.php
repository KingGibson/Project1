...
<div class="reservation" id="reservation">
    ...
    <div class="form">
        ...
        <form action="" method="post">
            ...
            <center><button type="submit" name="action" value="update" class="btn">Update</button></center>
        </form>
        ...
        <form action="" method="post">
            ...
            <input type="text" name="reservation_id" placeholder="Reservation ID">
            <center><button type="submit" name="action" value="delete" class="btn">Delete</button></center>
        </form>
    </div>
</div>
